...
import { loadScnetModel } from './scnet-model';
...
type Response =
  | { readonly type: 'ready'; readonly loadMs: number; readonly threads: number; readonly inputs: readonly string[]; readonly outputs: readonly string[] }
