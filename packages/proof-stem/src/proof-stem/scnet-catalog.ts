...
import type { ScnetModelDownloadProgress, ScnetModelId } from '@kelasmalam/platform/host';

/**
 * Id dan bentuk progres adalah bagian KONTRAK host (`PlatformHost.modelBytes`),
 * jadi keduanya didefinisikan di `@kelasmalam/platform/host` dan diekspor
 * ulang dari sini; `SCNET_MODELS` bertipe `Record<ScnetModelId, …>` supaya
 * katalog ini tidak bisa lupa menutupi satu id pun.
 */
export type { ScnetModelDownloadProgress, ScnetModelId };
